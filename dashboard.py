...
def loading_json_file():
    state_geo = 'https://raw.githubusercontent.com/Kangsungmin00/foodpoision_project/main/data/TL_SCCO_CTPRVN_%EB%8F%85%EB%8F%84%ED%91%9C%EA%B8%B0.json'
...
def main():
    ...
    # 지역별 데이터 로드 및 캐시 저장
    data = loading_data('https://raw.githubusercontent.com/Kangsungmin00/foodpoision_project/main/data/Foodborne_Region_MasterTable.csv')
    ...
    data_cause = loading_data('https://raw.githubusercontent.com/Kangsungmin00/foodpoision_project/main/data/Foodborne_Cause_MasterTable4.csv')
    ...
    data_cause_forecast = loading_data('https://raw.githubusercontent.com/Kangsungmin00/foodpoision_project/refs/heads/main/data/cause_prediction_12months.csv')
    data_region_forecast = loading_data('https://raw.githubusercontent.com/Kangsungmin00/foodpoision_project/refs/heads/main/data/region_prediction_12months.csv')

    # model = loading_model('https://github.com/Kangsungmin00/foodpoision_project/blob/main/data/test_clf_model.pkl')
    # model = model.best_estimator_

    # 지역별 모델 로드 및 캐시 저장
    model_강원 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EA%B0%95%EC%9B%90_GradientBoostingClassifier.pkl')
    model_경기 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EA%B2%BD%EA%B8%B0%20GradientBoostingClassifier.pkl')
    model_경북 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EA%B2%BD%EB%B6%81%20GradientBoostingClassifier.pkl')
    model_전남 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%A0%84%EB%82%A8%20GradientBoostingClassifier.pkl')
    model_경남 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EA%B2%BD%EB%82%A8%20LGBMClassifier.pkl')
    model_대구 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EB%B6%80%EC%82%B0%20LGBMClassifier.pkl')
    model_부산 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EB%B6%80%EC%82%B0%20LGBMClassifier.pkl')
    model_울산 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%9A%B8%EC%82%B0%20LGBMClassifier.pkl')
    model_인천 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%9D%B8%EC%B2%9C%20LGBMClassifier.pkl')
    model_전북 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%A0%84%EB%B6%81%20LGBMClassifier.pkl')
    model_제주 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%A0%9C%EC%A3%BC%20LGBMClassifier.pkl')
    model_광주 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EA%B4%91%EC%A3%BC%20LGBMClassifier.pkl')
    model_대전 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EB%8C%80%EC%A0%84%20XGBClassifier.pkl')
    model_서울 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%84%9C%EC%9A%B8%20GradientBoostingClassifier.pkl')
    model_충남 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%B6%A9%EB%82%A8%20GradientBoostingClassifier.pkl')
    model_세종 = loading_model('https://raw.github.com/Kangsungmin00/foodpoision_project/main/data/%EC%84%B8%EC%A2%85%20RandomForestClassifier.pkl')
